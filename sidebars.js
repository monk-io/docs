...
module.exports = {
    ...
    // FIXME - cannot remove guiSidebar without the build failing.
    //         would like to replace with a link back to the home page or sandbox
    guiSidebar: [
        {
            type: "category",
            label: "Monk GUI",
    ...
    mainSidebar: [
        ...
        // FIXME - even though the GUI is now Sandbox UI, it still opens the separate doc page when you click it.
        //         Unsure where the setting / config is to change this.
        {
            type: "category",
            label: "Sandbox UI",
            collapsed: true,
        ...
        },
        {
            ...
            label: "Contributors",
            collapsed: false,
            items: ["community/index", "community/publishers", "community/content", "community/bugs"],
        },
        // {
        //     type: "category",
        //     label: "Case Studies",
