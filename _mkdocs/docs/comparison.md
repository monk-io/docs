...
You could think of Monk Kits as superpowered Helm charts. Yet unlike Helm, Monk is built from the ground up to integrate its definition language and package management seamlessly.
...
-   **Scriptable actions**: You can execute code in your containers and communicate with your cloud provider directly from Monk, without a Dockerfile or even your cloud CLI. All you need is your Kit and the Monk [command line](cli/monk.md).
