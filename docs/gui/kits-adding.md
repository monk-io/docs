...
Having one or two instances set up, we are ready to add some services to the board. Click the pencil icon and select **Add kit**.
...
Once the kit is imported, you will see it as a box on the board, it can be dragged freely but let’s put it on **node-1**. When the kit is right-clicked, **Kit Configuration** panel pops up on the right side of the screen.
